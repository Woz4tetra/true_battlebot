...
})(
    {
                    ...
                    var t = {
                        encode: function (e) {
                            var o,
                                ...
                                l = 0;
                            function u(e) {
                                for (var t = a.byteLength, i = l + e; t < i; )
                                    t *= 2;
                                if (t !== a.byteLength)
                                    for (
                                        var n = c,
            ...
            function (e, U, E) {
                !function (M, A) {
                    !function () {
                        function h() {
                            (this._events = {}),
                                this._conf && t.call(this, this._conf);
                        }
                        function t(e) {
                            e &&
                                ((this._conf = e).delimiter &&
                                    (this.delimiter = e.delimiter),
                                e.maxListeners !== g &&
                                    (this._maxListeners = e.maxListeners),
                                e.wildcard && (this.wildcard = e.wildcard),
                                e.newListener &&
                                    (this._newListener = e.newListener),
                                e.removeListener &&
                                    (this._removeListener = e.removeListener),
                                e.verboseMemoryLeak &&
                        ...
                        (b = Object.hasOwnProperty),
                            ...
                            ((r.EventEmitter2 = r).prototype.listenTo =
                                function (l, e, u) {
                                    if ("object" != typeof l)
                                        throw TypeError(
                                            "target musts be an object"
                                        );
                                    var h = this;
                                    function t(e) {
                                        if ("object" != typeof e)
                            ...
                            (r.prototype.prependOnceListener = function (
                                e,
                                t,
                                i
                            ) {
                                    ...
                                    n !== g &&
                                        ((t = (n = function (e, t, i) {
                                            ...
                                            if (n || s || r) {
                                                ...
                                                if (s && !T)
                                                    throw Error(
                                                        "process.nextTick is not supported"
                                                    );
                                                r === g &&
                                                    (r =
                                                        "AsyncFunction" ===
                            ...
                            (r.prototype.listeners = function (e) {
                                ...
                                if (this.wildcard)
                                    throw Error(
                                        "event name required for wildcard emitter"
                                    );
                                if (!c) return [];
                    ...
                    try {
                        if (Object.assign) {
                            ...
                            if (
                                ...
                                var n,
                                    r = Object.getOwnPropertyNames(t).map(
                                        function (e) {
                                            return t[e];
                                        }
                                    );
                ...
                !function (i, a) {
                    !function () {
                        ...
                        (l.setTimeout = function () {
                            ...
                            (t.prototype.unref = t.prototype.ref =
                                function () {}),
                ...
                function m(e, t, i) {
                    ...
                    if (t) {
                        ...
                        for (
                            ...
                            e[s[2]] ||
                                (n[i].push(s[1]),
                                (e[s[2]] = __webpack_require__(s[1]).m)),
                                (n[s[2]] = n[s[2]] || []),
                                n[s[2]].push(s[4]);
                        for (
                            var a, c = Object.keys(n), l = 0;
                            l < c.length;
                            l++
                        )
                            for (var u = 0; u < n[c[l]].length; u++)
                                (a = n[c[l]][u]),
                                    isNaN(+a) || (n[c[l]][u] = +n[c[l]][u]);
                    }
                    return n;
                }
                function o(e, t) {
        ...
        7: [
            function (e, t, i) {
                ...
                t.exports = function (e, t) {
                    for (
                        var i = Object.keys(m), n = 0, r = i.length;
                        n < r;
                        n++
                    ) {
                        var s = i[n],
                    ...
                    (this.feedbackListener = new n({
                        ...
                        this.omitFeedback ||
                            this.feedbackListener.subscribe(function (e) {
                                ...
                                t &&
                                    (t.emit("status", e.status),
                                    t.emit("feedback", e.feedback));
                            }),
                        this.omitResult ||
                ...
                function n(e) {
                    ...
                    (this.statusMessage = new o({
                        ...
                        r.subscribe(function (e) {
                            ...
                            "" === e.id
                                ? ((i.nextGoal = null),
                                  i.currentGoal && i.emit("cancel"))
                                : (i.currentGoal &&
                                  e.id === i.currentGoal.goal_id.id
                                      ? i.emit("cancel")
                                      : i.nextGoal &&
            ...
            function (e, t, i) {
                ...
                function l(e) {
                    ...
                    (this.socket = null),
                        (this.idCounter = 0),
                        (this.isConnected = !1),
                        (this.transportLibrary =
                            e.transportLibrary || "websocket"),
                        ...
                        void 0 === e.groovyCompatibility
                            ...
                            : (this.groovyCompatibility =
                                  e.groovyCompatibility),
                ...
                (l.prototype.__proto__ = e.prototype),
                    (l.prototype.connect = function (e) {
                        if ("socket.io" === this.transportLibrary)
                            ...
                            "RTCPeerConnection" ===
                            this.transportLibrary.constructor.name
                        )
                            this.socket = c(
                            ...
                            var t;
                            (this.socket &&
                                this.socket.readyState !== n.CLOSED) ||
                    ...
                    (l.prototype.getServiceResponseDetails = function (
                        e,
                        t,
                        i
                    ) {
                ...
                (n.prototype.__proto__ = e.prototype),
                    ...
                    (n.prototype.advertise = function (e) {
                        this.isAdvertised ||
                            ...
                            this.ros.on(
                                this.name,
                                this._serviceResponse.bind(this)
                            ),
            ...
            function (e, t, i) {
                ...
                "undefined" != typeof bson && (l = bson().BSON),
                    (t.exports = function (t) {
                        ...
                        return (
                            t.transportOptions.decoder &&
                                (r = t.transportOptions.decoder),
                            {
                                onopen: function (e) {
                                    (t.isConnected = !0),
                                        t.emit("connection", e);
                ...
                function s(e) {
                    (this.ros = (e = e || {}).ros),
                        ...
                        (this.reconnect_on_close =
                            void 0 === e.reconnect_on_close ||
                            e.reconnect_on_close),
                        this.compression &&
            ...
            function (e, t, i) {
                ...
                function l(e) {
                    ...
                    (this.topicTimeout = { secs: i, nsecs: t }),
                        (this.serverName =
                            e.serverName || "/tf2_web_republisher"),
                        (this.repubServiceName =
                            e.repubServiceName || "/republish_tfs"),
                        (this.currentGoal = !1),
                        (this.currentTopic = !1),
                        (this.frameInfos = {}),
                ...
                t.exports = function (e) {
                    (this.type = n.URDF_CYLINDER),
                        (this.length = parseFloat(
                            e.xml.getAttribute("length")
                        )),
                        (this.radius = parseFloat(
                            e.xml.getAttribute("radius")
                        ));
                };
            },
            { "./UrdfTypes": 41 },
                    ...
                    0 < a.length && (this.parent = a[0].getAttribute("link")),
                        ...
                        0 < (a = e.xml.getElementsByTagName("limit")).length &&
                            ((this.minval = parseFloat(
                                a[0].getAttribute("lower")
                            )),
                            (this.maxval = parseFloat(
                                a[0].getAttribute("upper")
                            ))),
                                ...
                                for (var a = 0; a < o.visuals.length; a++) {
                                    ...
                                    null !== c &&
                                        ...
                                        (void 0 !== this.materials[c.name]
                                            ? (o.visuals[a].material =
                                                  this.materials[c.name])
        ...
        46: [
            function (e, t, i) {
                t.exports =
                    "undefined" != typeof window ? window.WebSocket : WebSocket;
            },
            {},
        ],
        47: [
                        ...
                        for (
                            var e = new a(),
                                ...
                                i =
                                    ...
                                    t.drawImage(o, 0, 0),
                                    t.getImageData(0, 0, o.width, o.height)
                                        .data),
                                n = "",
                                r = 0;
                            r < i.length;
