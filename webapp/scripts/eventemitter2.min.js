...
!(function (e) {
    ...
    function g(e, t, r, n, i) {
        ...
        if (((v = r["*"]) && g(e, t, v, n + 1, i), (y = r["**"])))
            if (n < i)
                for (
                    y._listeners && g(e, t, y, i, i), a = (d = l(y)).length;
                    a-- > 0;
    ...
    function E(e, t, r, n) {
        for (
            var i, s, o, a, f = l(e), h = f.length, c = e._listeners;
            h-- > 0;
    ...
    (j.prototype.off = function () {
        ...
        (x.prototype.listenTo = function (t, n, i) {
            ...
            return (
                ...
                r(n)
                    ? o(u(n))
                    : o("string" == typeof n ? u(n.split(/\s+/)) : n),
                this
            );
        }),
                        ...
                        function o() {
                            ...
                            if (!s || s.apply(n, arguments))
                                if ((n.off(t, o), r.handleError)) {
                                    ...
                                    l
                                        ? i(l)
                                        : e(c.apply(null, arguments).slice(1));
