...
bool CrsfBridge::update(radio_data_t *radio_data)
{
    ...
    if (crsf->isLinkUp())
    {
        ...
        radio_data->c_percent = get_button_state(channels->ch1);
        ...
        radio_data->lifter_command = scale_channel_to_percent(channels->ch7);
