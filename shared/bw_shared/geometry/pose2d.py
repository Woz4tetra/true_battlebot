...
from bw_shared.geometry.rotation_transforms import euler_from_quaternion, quaternion_from_euler
...
class Pose2D:
    ...
    @classmethod
    def from_msg(cls, msg: Pose) -> Pose2D:
        angles = euler_from_quaternion(msg.orientation)
        return cls(
            x=msg.position.x,
            y=msg.position.y,
            theta=angles[2],
