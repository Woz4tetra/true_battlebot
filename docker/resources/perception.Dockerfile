...
ENV PATH=/opt/${ORGANIZATION}/scripts:/opt/${ORGANIZATION}/${PROJECT_NAME}/perception/scripts:${HOME}/.local/bin${PATH:+:${PATH}} \
    PYTHONPATH=/opt/${ORGANIZATION}/build/install:/opt/${ORGANIZATION}/${PROJECT_NAME}/perception/packages:/opt/${ORGANIZATION}/${PROJECT_NAME}/shared${PYTHONPATH:+:${PYTHONPATH}} \
