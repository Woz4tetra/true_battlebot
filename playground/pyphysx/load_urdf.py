...
position_control = False  # Select position control (if True) or velocity control (if False)
...
while render.is_active:
    ...
    render.update_label_text(
        label_joints,
        "Command: rz: {:.2f}, tz: {:.2f}, ty: {:.2f}".format(
