...
class CotrackerSam2AiInterpolator(AiInterpolatorInterface):
    ...
    def interpolate(
        ...
        with torch.autocast("cuda", dtype=torch.bfloat16):
            ...
            frames = self.load_images_alphabetically(images_dir)
            ...
            for annotation in interpolated_annotations:
                self.save_annotation(images_dir, annotation)
            self.remove_pytorch_loggers()
