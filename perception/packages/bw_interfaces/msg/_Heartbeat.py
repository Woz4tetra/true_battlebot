...
"""autogenerated by genpy from bw_interfaces/Heartbeat.msg. Do not edit."""
import codecs
import sys
...
class Heartbeat(genpy.Message):
  _md5sum: str = "7a04365505b48341f8d56a64e9b4f777"
  _type: str = "bw_interfaces/Heartbeat"
...
string frame_id
"""
  __slots__: List[str] = ['header','node_name']
  _slot_types: List[str] = ['std_msgs/Header','string']
  ...
  def __init__(self, header: std_msgs_msg_Header = None,
    ...
    """
    super(Heartbeat, self).__init__(**{'header': header, 'node_name': node_name})
  ...
  def deserialize(self, bytes_: bytes) -> 'Heartbeat':
    """
    ...
    try:
      ...
      if python3:
        self.node_name = bytes_[start:end].decode('utf-8', 'rosmsg')
      else:
        self.node_name = bytes_[start:end]
      return self
