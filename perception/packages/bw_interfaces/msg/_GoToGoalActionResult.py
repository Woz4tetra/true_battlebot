...
"""autogenerated by genpy from bw_interfaces/GoToGoalActionResult.msg. Do not edit."""
import codecs
import sys
...
class GoToGoalActionResult(genpy.Message):
  _md5sum: str = "0698ce25b2d595b82357c010557e935f"
  _type: str = "bw_interfaces/GoToGoalActionResult"
...
bool success"""
  __slots__: List[str] = ['header','status','result']
  _slot_types: List[str] = ['std_msgs/Header','actionlib_msgs/GoalStatus','bw_interfaces/GoToGoalResult']

  def __init__(self, header: std_msgs_msg_Header = None,
    status: actionlib_msgs_msg_GoalStatus = None,
    result: bw_interfaces_msg_GoToGoalResult = None):
    """
    ...
    """
    super(GoToGoalActionResult, self).__init__(**{'header': header, 'status': status, 'result': result})
    ...
    if self.result is None:
      self.result: bw_interfaces_msg_GoToGoalResult = bw_interfaces_msg_GoToGoalResult()
    else:
      self.result = result
  ...
  def deserialize(self, bytes_: bytes) -> 'GoToGoalActionResult':
    """
    ...
    try:
      ...
      if self.result is None:
        self.result = bw_interfaces_msg_GoToGoalResult()
      end = 0
      _x = self
      start = end
      end += 12
      ...
      (self.result.success,) = _get_struct_B().unpack(bytes_[start:end])
