...
class HealthSummary(genpy.Message):
  _md5sum = "ce57e7b2bf73c946886451233f8977ba"
  _type = "bw_interfaces/HealthSummary"
...
string frame_id
"""
  __slots__ = ['header','active_nodes','dead_nodes']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(HealthSummary, self).__init__(*args, **kwds)
