...
class SegmentationInstanceArray(genpy.Message):
  _md5sum = "a905b27e8b85409791a34c06a3aa97de"
  _type = "bw_interfaces/SegmentationInstanceArray"
...
uint32 y
"""
  __slots__ = ['header','height','width','instances']
  _slot_types = ['std_msgs/Header','uint32','uint32','bw_interfaces/SegmentationInstance[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SegmentationInstanceArray, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = bw_interfaces.msg.SegmentationInstance()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.contours = []
        for i in range(0, length):
          val2 = bw_interfaces.msg.Contour()
          start = end
          end += 4
          (length,) = _struct_I.unpack(str[start:end])
          val2.points = []
          for i in range(0, length):
            val3 = bw_interfaces.msg.UVKeypoint()
            _x = val3
            start = end
            end += 8
          ...
          (val2.area,) = _get_struct_d().unpack(str[start:end])
