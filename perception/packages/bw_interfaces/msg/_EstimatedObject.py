...
class EstimatedObject(genpy.Message):
  _md5sum = "affecfd33560537f4c35cd0836d232f0"
  _type = "bw_interfaces/EstimatedObject"
...
float64 y
float64 z"""
  __slots__ = ['header','child_frame_id','pose','twist','size','label']
  _slot_types = ['std_msgs/Header','string','geometry_msgs/PoseWithCovariance','geometry_msgs/TwistWithCovariance','geometry_msgs/Vector3','string']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(EstimatedObject, self).__init__(*args, **kwds)
