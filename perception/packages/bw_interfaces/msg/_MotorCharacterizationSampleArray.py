  ...
  def deserialize(self, bytes_: bytes) -> 'MotorCharacterizationSampleArray':
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (_v183.seq,) = _get_struct_I().unpack(bytes_[start:end])
        _v184 = _v183.stamp
        _x = _v184
        start = end
        end += 8
        ...
        if python3:
          _v183.frame_id = bytes_[start:end].decode('utf-8', 'rosmsg')
        else:
          _v183.frame_id = bytes_[start:end]
        _x = val1
        start = end
        end += 12
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (_v187.seq,) = _get_struct_I().unpack(bytes_[start:end])
        _v188 = _v187.stamp
        _x = _v188
        start = end
        end += 8
        ...
        if python3:
          _v187.frame_id = bytes_[start:end].decode('utf-8', 'rosmsg')
        else:
          _v187.frame_id = bytes_[start:end]
        _x = val1
        start = end
        end += 12
        (_x.channel, _x.velocity,) = _get_struct_id().unpack(bytes_[start:end])
