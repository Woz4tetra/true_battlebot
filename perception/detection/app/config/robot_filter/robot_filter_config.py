...
class RobotFilterConfig:
    ...
    robot_position_covariance: float = 0.001
    robot_orientation_covariance: float = 0.001
    cmd_vel_base_covariance_scalar: float = 0.01
    process_noise: float = 1e-4
    stale_timeout: float = 10.0
    robot_min_radius: float = 0.05
    robot_max_radius: float = 0.15
    ignore_measurement_near_tag_threshold: float = 0.05
    field_buffer: float = 0.2
    tag_rolling_median_window: int = 5
    estimated_system_lag: float = 0.0
