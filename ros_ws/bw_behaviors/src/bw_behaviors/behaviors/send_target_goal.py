...
class SendTargetGoal(Behaviour):
    def __init__(self, container: Container, target_type: TargetType, continuously_select_goal: bool) -> None:
    ...
    def initialise(self) -> None:
        self.go_to_goal_manager.send_target_goal(self.target_type, self.continuously_select_goal)
